...
public class ProcCylinder : ProcBase
{
	...
	public int m_HeightSegmentCount = 1;
	...
	public override Mesh BuildMesh()
	{
				...
				for (int i = 0; i <= m_HeightSegmentCount; i++)
		{
			...
			BuildRingInverted(meshBuilder, m_RadialSegmentCount, centrePos, m_Radius-m_Thickness, v, i > 0);
		}
		BuildRingFlat(meshBuilder, m_RadialSegmentCount, Vector3.up * 0, m_Radius,m_Radius-m_Thickness, 0, true);
		BuildRingFlat(meshBuilder, m_RadialSegmentCount, Vector3.up * m_Height, m_Radius,m_Radius-m_Thickness, 1, true);
		////caps:
